...
import { BookByName, BooksData, GET_BOOKS_BY_NAME, GetBookByNameVariables } from "../graphql/queries/getBookByName";
import { COUNT_BOOK, CountBooks } from "../graphql/queries/countBooks";
...
function BookSearchContextProvider({ children }: PropsWithChildren<{}>) {
  ...
  const [ getBooksByName, { loading, data } ] = useLazyQuery<BooksData,
    GetBookByNameVariables>(GET_BOOKS_BY_NAME, {
    variables: {
      term,
      page,
    },
