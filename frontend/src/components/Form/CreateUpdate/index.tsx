...
import { CREATE_BOOK, CreateBookInput, SavedBook } from "../../../graphql/mutations/createBook";
import { UPDATE_BOOK, UpdateBookInput, UpdatedBook } from "../../../graphql/mutations/updateBook";
import { GET_BOOK_TO_UPDATE, GetBook, GetBookQueryParams } from "../../../graphql/queries/getBook";
...
export function FormCreateUpdate({}: PropsWithChildren<{}>) {
  ...
  const [ getBook, { data: persistedBook } ] = useLazyQuery<GetBook,
    GetBookQueryParams>(GET_BOOK_TO_UPDATE, {
    variables: {
      _id,
    },
